...
if __name__ == '__main__':
    label = 'predict'
    iteration = 0
    imgPath = '/Users/kjams/Desktop/interface/jiji/me.jpg'
    ...
    while iteration < 4:
        ...
        print('graphInput processed. Start learning from feedback ')
        feedback = prediction.processFeedback()
        print('finished examining feedback')
        if feedback == 0:
            break
        thoughtProcess[iteration] = feedback
        iteration+=1
