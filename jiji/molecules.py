...
class Molecule:
    ...
    # TODO: Retrain on personal data :)
    # Flask app to automate this daily task
    def train(self, k=3):
        ...
        self.feelingMentalMap = collections.defaultdict(list)
            ...
            for imgFolder in os.listdir('eyeData/'+label):
                ...
                if delta.x and delta.y:
                    ...
                    if abs(x-y) <= 25:
                        ...
                        self.feelingMentalMap[label].append(delta)
